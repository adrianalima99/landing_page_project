...
**TechLanding** é uma landing page moderna e responsiva desenvolvida para demonstrar habilidades em desenvolvimento web frontend. Este projeto foi criado como parte do portfólio pessoal, mostrando capacidade de criar interfaces elegantes e funcionais.
...
- **Tecnologias** com apresentação das tecnologias utilizadas
...
├── TUTORIAL.md            # Tutorial de uso e manutenção
...
- **[DOCUMENTACAO_SISTEMA.md](DOCUMENTACAO_SISTEMA.md)** - Documentação completa do sistema
- **[TUTORIAL.md](TUTORIAL.md)** - Tutorial de uso e manutenção
...
*Este projeto faz parte do portfólio pessoal e demonstra habilidades em desenvolvimento web moderno.*
